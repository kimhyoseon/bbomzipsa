...
if (!empty($_POST)) {
    ...
    } else if ($_POST['type'] == 'jshk_sendall_lotte') {
        $excel->sendallLotte($_FILES['input'], $_FILES['output'], $_POST['date']);
    ...
    <form action="" method="POST" accept-charset="UTF-8" enctype="multipart/form-data" class="form-signin">
        ...
        <div class="form-group">
            <select id="type" name="type" class="form-control">
                ...
                <option value="jshk_sendall_lotte">엑셀일괄발송(롯데)</option>
...
$('select[name=type]').change(function(){
    if ($(this).val() == 'sendall' || $(this).val() == 'jshk_sendall_lotte') {
