...
return array(
    ...
    '어묵마늘쫑볶음' => array( // 2020-09-30
        ...
        '어묵' => array(140, 'g', true, '국산'),
        '마늘쫑' => array(50, 'g', true, '중국'),
        '간장볶음소스' => array(50, 'g', false, ''),
        '깨' => array(1, 'g', false, '국산'),
        '물엿' => array(5, 'g', false, '국산'),
        '참기름' => array(1, 'g', false, '국산'),
    ...
    '감자조림' => array( // 2020-09-30
        ...
        '감자' => array(260, 'g', true, '국산'),
        '당근' => array(30, 'g', true, '국산'),
        '간장조림소스' => array(60, 'g', false, ''),
        '깨' => array(1, 'g', false, '국산'),
        '참기름' => array(1, 'g', false, '국산'),
    ),
    ...
    '분홍소세지' => array( // 2020-09-30
        ...
        '계란' => array(0.5, '개', true, '국산'),
        '소세지' => array(160, 'g', true, '국산'),
        '쪽파' => array(0.2, 'g', true, '국산'),
        '맛기름' => array(4, 'g', false, '국산'),
        '깨' => array(1, 'g', false, '국산'),
    ),
    ...
    '수제단호박샐러드' => array( // 2020-09-30
        ...
        '단호박' => array(130, 'g', true, '국산'),
        '옥수수' => array(20, 'g', true, '국산'),
        '호박씨' => array(7, 'g', true, '중국'),
        '해바라기씨' => array(7, 'g', true, '중국'),
        '건포도' => array(1, 'g', true, '국산'),
    ...
    '매콤코다리조림' => array( // 2020-09-30
        ...
        '코다리' => array(1.5, '마리', true, '국산'),
        '무' => array(0.2, '개', true, '국산'),
        '양파' => array(1, 'g', false, '국산'),
        '대파' => array(1, 'g', true, '국산'),
        '고추' => array(1, 'g', true, '국산'),
        '고추장' => array(1, 'g', false, '국산'),
        '고춧가루' => array(1, 'g', false, '국산'),
        '맛간장' => array(1, 'g', false, '국산'),
        '깨' => array(1, 'g', false, '국산'),
        '참기름' => array(1, 'g', false, '국산'),
    ...
    '매콤콩나물불고기' => array( // 2020-09-30
        ...
        '대패삽겹살' => array(200, 'g', true, '국산'),
        '콩나물' => array(100, 'g', true, '국산'),
        '당면' => array(5, 'g', true, '국산'),
        '고추' => array(1, 'g', true, '국산'),
        '양파' => array(1, 'g', false, '국산'),
        '깻잎' => array(1, 'g', true, '국산'),
        '고추장' => array(1, 'g', false, '국산'),
        '맛간장' => array(1, 'g', false, '국산'),
        '전분' => array(1, 'g', false, '국산'),
        '깨' => array(1, 'g', false, '국산'),
        '참기름' => array(1, 'g', false, '국산'),
    ),
    ...
    '황태국' => array(
        ...
        '대파' => array(2, 'g', true, '국산'),
        '마늘' => array(2, 'g', false, '국산'),
        '들기름' => array(2, 'g', false, '국산'),
        '국간장' => array(2, 'g', false, '국산'),
        '멸치액젓' => array(2, 'g', false, '국산'),
    ),
    '어묵국' => array( // 2020-09-30
        '_total' => array(700, 'g', false, ''),
        '_expired' => array(7, 'days', false, ''),
        '_soup' => 1,

        '어묵' => array(100, 'g', true, '국산'),
        '무' => array(0.2, '개', true, '국산'),
        '대파' => array(1, 'g', true, '국산'),
        '멸치육수' => array(1, 'g', false, '국산'),
        '국간장' => array(1, 'g', false, '국산'),
        '소금' => array(1, 'g', false, '국산'),
        '마늘' => array(1, 'g', false, '국산'),
    ),
    '순두부찌개' => array( // 2020-09-30
        '_total' => array(700, 'g', false, ''),
        '_expired' => array(7, 'days', false, ''),
        '_soup' => 1,

        '순두부' => array(1.5, '개', true, '국산'),
        '돼지고기(다진)' => array(60, 'g', true, '국산'),
        '애호박' => array(1, 'g', true, '국산'),
        '대파' => array(1, 'g', true, '국산'),
        '양파' => array(1, 'g', false, '국산'),
        '마늘' => array(1, 'g', false, '국산'),
        '고춧가루' => array(1, 'g', false, '국산'),
    ...
    '청국장찌개' => array( // 2020-09-30
        '_total' => array(700, 'g', false, ''),
        '_expired' => array(7, 'days', false, ''),
        '_soup' => 1,

        '청국장' => array(200, 'g', true, '미국'),
        '무' => array(0.2, '개', true, '국산'),
        '양파' => array(1, 'g', false, '국산'),
        '고추' => array(1, 'g', false, '국산'),
        '두부' => array(1, 'g', true, '국산'),
        '마늘' => array(1, 'g', false, '국산'),
        '대파' => array(1, 'g', true, '국산'),
        '표고버섯' => array(1, 'g', false, '국산'),
        '김치' => array(1, 'g', false, '국산'),
    ),
